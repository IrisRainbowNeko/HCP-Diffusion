from rainbowneko.ckpt_manager import NekoSaver, CkptFormat, LocalCkptSource
from torch import nn
from typing import Dict, Any

class EmbSaver(NekoSaver):
    def __init__(self, format: CkptFormat, source: LocalCkptSource, layers='all', state_prefix='', target_key='embs', prefix=None):
        super().__init__(format, source, layers=layers, state_prefix=state_prefix)
